...
urlpatterns = [
    ...
    path("produto/volume/", views.produto_volume, name="produto_volume"),
    path("produto/codvol/", views.produto_codvol, name="produto_codvol"),
    ...
    path("nota/check-classificacao/", views.nota_check_classificacao, name="nota_check_classificacao"),
    path("nota/check-negociacao/", views.nota_check_negociacao, name="nota_check_negociacao"),
    ...
    path("comercial/peso/save/", views.comercial_peso_save, name="comercial_peso_save"),
