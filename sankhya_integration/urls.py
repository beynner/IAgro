...
# ==============================================================================
    ...
    # B5 Mai/2026 (2026-05-22) — Confirmar pedido (STATUSNOTA='L', equivalente ao CONFIRMAR do Sankhya)
    path("venda/api/confirmar/", views.api_confirmar_pedido_venda, name="api_confirmar_pedido_venda"),
