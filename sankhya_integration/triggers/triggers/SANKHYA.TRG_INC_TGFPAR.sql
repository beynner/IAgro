-- SANKHYA.TRG_INC_TGFPAR
CREATE OR REPLACE TRIGGER SANKHYA.TRG_INC_TGFPAR
"SANKHYA".TRG_INC_TGFPAR
   BEFORE INSERT
   ON TGFPAR
...
BEGIN
   ...
   -- OS 1299388 TRECHO EXCLUÍDO POR JÁ ESTAR CONTIDO NA TRIGGER TRG_INC_UPD_TGFPAR_AFTER
