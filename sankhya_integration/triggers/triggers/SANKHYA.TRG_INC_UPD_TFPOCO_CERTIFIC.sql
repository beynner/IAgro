-- SANKHYA.TRG_INC_UPD_TFPOCO_CERTIFIC
CREATE OR REPLACE TRIGGER SANKHYA.TRG_INC_UPD_TFPOCO_CERTIFIC
"SANKHYA".TRG_INC_UPD_TFPOCO_CERTIFIC BEFORE INSERT OR UPDATE ON TFPOCO FOR EACH ROW
...
BEGIN
  ...
  IF ((INSERTING) OR
   ...
   AND CODFUNC = :NEW.CODFUNC;
      ...
      ELSE
        CLOSE curRegras;					
     ERRMSG := 'InstruiÃ§Ã£o principal "'|| P_INSTPRINC ||'" da regra "' || P_DESCRREGRA || '" nÃ£o definida.';
     RAISE ERROR;
      END IF;
      ...
      ELSIF P_INSTSEC IS NOT NULL AND P_INSTSEC <> '' THEN
        CLOSE curRegras;
     ERRMSG := 'InstruiÃ§Ã£oo secundÃ¡ria "'|| P_INSTSEC ||'" da regra "' || P_DESCRREGRA || '" nÃ£o definida.';
     RAISE ERROR;
      ELSE
        P_CODINSTSEC := 0;
      END IF;
