-- SANKHYA.TRG_INC_UPD_TFPVAL_CERTIFIC
CREATE OR REPLACE TRIGGER SANKHYA.TRG_INC_UPD_TFPVAL_CERTIFIC
"SANKHYA".TRG_INC_UPD_TFPVAL_CERTIFIC BEFORE INSERT OR UPDATE ON TFPVAL FOR EACH ROW
