-- SANKHYA.TRG_INC_UPD_TFPBAS_CERTIFIC
CREATE OR REPLACE TRIGGER SANKHYA.TRG_INC_UPD_TFPBAS_CERTIFIC
"SANKHYA".TRG_INC_UPD_TFPBAS_CERTIFIC BEFORE INSERT OR UPDATE ON TFPBAS FOR EACH ROW
...
DECLARE
  ...
  CURSOR  curRegras IS
    ...
    WHERE ((CER.TIPO = 'U' AND CER.CHAVE = :NEW.CODUSU) OR
        /* (CER.TIPO = 'F' AND CER.CHAVE = :NEW.CODFUNC AND CER.CHAVE IN (SELECT CODFUNC FROM TFPFUN WHERE CODEMP = :NEW.CODEMP AND CODFUNC = :NEW.CODFUNC)) OR removido na OS 4626111 e 4687757 */
